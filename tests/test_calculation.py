...
@patch.object(operations, 'add', return_value=15.0)
...
@patch.object(operations, 'subtract', return_value=5.0)
...
@patch.object(operations, 'multiply', return_value=50.0)
...
@patch.object(operations, 'divide', return_value=2.0)
